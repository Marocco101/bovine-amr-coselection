...
# File paths
file_col <- "data/bovin_colistin_2019_fixed.csv"
file_tmp <- "data/bovin_trimsalfa_2019_fixed.csv"
...
file_tet <- "data/bovin_tetra_2019_fixed.csv"
...
p2 <- ggplot(df_merged_tet, aes(x = rate_tetra, y = rate_colistin)) +
  ...
  labs(
    ...
    subtitle = paste("Bovine E. coli (2019) | Pearson r =", round(cor_res_tet$estimate, 2), 
